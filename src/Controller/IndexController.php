...
return $this->render('newCategory.html.twig',['form'=>$form->createView()]);
 }
...
public function articlesParCategorie(Request $request) {
   ...
   if($form->isSubmitted() && $form->isValid()) {
     ...
     $articles= $category->getArticles();
      ...
      return $this->render('articlesParCategorie.html.twig',['form' => $form->createView(),'articles' => $articles]);
      }
...
return $this->render('articlesParPrix.html.twig',[ 'form' =>$form->createView(), 'articles' => $articles]); 
